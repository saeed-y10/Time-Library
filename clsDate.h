...
public:
	...
	clsDate(string Date)
	{
		...
		else if (clsString::Split(Date, "/").size() < 3)
		{
			*this = GetSystemDate();
		}
	...
	{
		*this = IncreaceDateByNDays(Days, *this);
	}
	...
	{
		*this = IncreaseDateByNWeeks(Weeks, *this);
	}
	...
	{
		*this = IncreaseDateByNMonths(Months, *this);
	}
	...
	{
		*this = IncreaseDateByNYears(Years, *this);
	}
	...
	{
		*this = IncreaseDateByNDecades(Decades, *this);
	}
	...
	{
		*this = DecreaseDateByNDays(Days, *this);
	}
	...
	{
		*this = DecreaseDateByNWeeks(Weeks, *this);
	}
	...
	{
		*this = DecreaseDateByNMonths(Months, *this);
	}
	...
	{
		*this = DecreaseDateByNYears(Years, *this);
	}
	...
	{
		*this = DecreaseDateByNDecades(Decades, *this);
	}
	...
	{
		*this = DecreaseOneMillennuim(*this);
	}
	...
	static int CalculateAgeInYears(clsDate DateOfBirth)
	{
		if (IsDateBeforeDate2(DateOfBirth, GetSystemDate()))
			return GetSystemDate().Year - DateOfBirth.Year;
	...
	{
		return CalculateAgeInYears(*this);
	}
